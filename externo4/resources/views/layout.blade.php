...
-->
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel" data-interval="1800">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/img/ss7.jpg" class="d-block w-100" alt="Smiley face" height="430">
                </div>
                <div class="carousel-item">
                    <img src="/img/ss4.jpg" class="d-block w-100" alt="Smiley face" height="430">
                </div>
                <div class="carousel-item">
                    <img src="/img/ss2.jpg" class="d-block w-100" alt="Smiley face" height="430">
                </div>
        ...
        <ul class="nav justify-content-center">
            <li class="nav-item">
                <a href="{{ url('Ver/Electrico') }}"><button type="button" class="btn btn-outline-success btn-lg">Electrico</button></a>
            </li>
            <li class="nav-item">

                <a href="{{ url('Ver/GriferiaPlomeria') }}"><button type="button" href="" class="btn btn-outline-success btn-lg">Griferia y plomeria</button></a>
            </li>
            <li class="nav-item">

                <a href="{{ url('Ver/NivelIndustrial') }}"><button type="button" href="" class="btn btn-outline-success btn-lg">Nivel e industrial</button></a>
            </li>
            <li class="nav-item">

                <a href="{{ url('Ver/Remaches') }}"><button type="button" href="" class="btn btn-outline-success btn-lg">Remaches</button></a>
            </li>
            <li class="nav-item">

                <a href="{{ url('Ver/Tornilleria') }}"><button type="button" href="" class="btn btn-outline-success btn-lg">Tornilleria</button></a>
            </li>
        </ul>
        <br>
        <br>
