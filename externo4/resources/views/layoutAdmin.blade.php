...
<body>
    ...
    <header>
        ...
        <nav class="navbar navbar sticky-top navbar-expand-lg navbar navbar-light " style="background-color: #F07C09;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    @endauth
                    <li class="nav-item">
                        <a class="nav-link " href="#"><img src="https://img.icons8.com/material-rounded/80/000000/shopping-cart.png" height="50"><span class="sr-only">(current)</span></a>
        ...
        <ul class="nav justify-content-center">
            <li class="nav-item">
                <a href="{{ url('estadistica') }}"><button type="button" class="btn btn-outline-success btn-lg">Estadística</button></a>
            </li>
            <li class="nav-item">
                <form action="Inventario" method="GET">
                    <input type="hidden" id="nombre" name="nombre" value="nombre">
                    <button type="submit" class="btn btn-outline-success btn-lg"> Inventario </button>
                </form>
            </li>
            ...
            <li class="nav-item">
                <form action="Pedidos" method="GET">
                    <input type="hidden" id="nombre" name="nombre" value="nombre">
                    <button type="submit" class="btn btn-outline-success btn-lg"> Ventas </button>
                </form>
            </li>
            ...
            <li class="nav-item">
                <form action="Cliente" method="GET">
                    <input type="hidden" id="nombre" name="nombre" value="nombre">
                    <button type="submit" class="btn btn-outline-success btn-lg"> Cliente </button>
                </form>
            </li>
